...
function sanctuary_setup() {
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'sanctuary' ),
	) );
 ...
 */
function sanctuary_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'sanctuary_content_width', 640 );
}
add_action( 'after_setup_theme', 'sanctuary_content_width', 0 );
...
function sanctuary_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'sanctuary' ),
		'id'            => 'sidebar-1',
		'description'   => '',
...
function sanctuary_scripts() {
	...
	wp_enqueue_script( 'sanctuary-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'sanctuary-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
